    ...
    <div id="cart-modal" class="modal">
        <div class="modal-content cart-content">
            ...
            <div id="cart-items-container">
                <div class="cart-item">
                    <img src="{{ asset('images/Kaus-Polo-Scuderia-Ferrari-2025-Team-Pria.jpg') }}" alt="Polo Ferrari" class="cart-item-image">
            ...
            <a href="#" class="btn btn-primary login-submit-btn checkout-btn">Lanjutkan ke Pembayaran</a>
        </div>
    </div>
